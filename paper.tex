...
problems is still very difficult. Without adequate profiling tools, we found
ourselves puzzled by the lackluster results of our experiments. With more time,
we could probably use the Spark logs to better understand where our serial
bottlenecks are and increase efficiency. It may very well still be worth
exploring how Spark could be used on JANUS, but it may require rethinking
how we are using the network and filesystems for this task.
